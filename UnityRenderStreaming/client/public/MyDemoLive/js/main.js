...
function onClickPlayButton() {
  ...
  setupVideoPlayer([elementVideo, elementVideoThumb]).then(value => {
    videoPlayer = value;
    
    // After the video player is set up, remove the thumbnail if desired
    elementVideoThumb.remove(); // Removes the thumbnail
  });
